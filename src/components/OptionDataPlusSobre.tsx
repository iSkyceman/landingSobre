...
// ---- Données métier ----
const VALID_CODES = [
  { code: "DATA2025-SOCX98", nom: "Société Test", email: "contact@exemple.com", siren: "123456789", secteur: "industrie", salaries: "23", adresse: "5 rue des Innovations, 67210 Obernai" },
  { code: "ESSAI2025-SOBRE", nom: "DemoClient", email: "iskyceman@gmail.com", siren: "111222333", secteur: "bâtiment", salaries: "48", adresse: "1 route de Testville, 67000 Strasbourg" }
];
const FORMULES = [
...
`.trim(); // (raccourci ici, mets ton texte réel)
...
// --- CodeInputSection (externe & focus clean) ---
      ...
      <div className={styles.modalBody}>
        {step === 0 && (
          <form onSubmit={handleFormSubmit} autoComplete="off">
            ...
            <button className={styles.buttonBlue} type="submit">Suivant →</button>
          </form>
        )}
        {step === 1 && (
          <div>
            ...
            <button className={styles.buttonBlue} type="button" onClick={handleContratAccept} disabled={!contratLu}>
...
export default function OptionDataPlusSobre() {
  ...
  function buildContractHtml() {
    return `
      <h3 style="text-align:center;font-family:inherit;color:#f76d3c;">
        Abonnement Data+ SOBRE <span style="font-size:1.22em;">📊</span>
      </h3>
      ...
      <hr/>
      <div style="font-size:0.92em;line-height:1.5;text-align:left;max-height:300px;overflow:auto;color:#22305a;">
  ...
  function validerPaiement() {
    ...
    setTimeout(() => {
      const dossier = {
        reference: ref, ...fields, abonnement: "Data+ Sobre", formule: FORMULES.find(f => f.value === formule)?.label, paiement, prix,
        codeClient: code, contrat: buildContractHtml(), date: new Date().toISOString(), provenance: "abosDataPlusSobre"
      };
  ...
  function handleDownloadPdf() {
    ...
    downloadPDF(container, `Contrat-DataPlus-${fields.nom.replace(/\s/g, "_") || "Client"}-${refDossier}.pdf`);
    setEmailSent(true);
      ...
      <div className={styles.tunnelModalOverlay}>
        <div className={styles.fullscreenModal}>
          ...
          <div className={styles.modalContent}>
            <strong style={{color:"#f76d3c"}}>Data+ : l’abonnement réservé aux industriels engagés dans la transformation 5.0</strong><br /><br />
            ...
            <strong style={{color:"#f76d3c"}}>Rejoignez les industriels qui anticipent, innovent et gardent une longueur d’avance.</strong>
            <br /><br />
            <a
              href="https://drive.google.com/file/d/1_HeICEiGO4vPFQK7gIPniHxc6s3xuMAp/view"
              target="_blank"
  ...
  return (
    <section className={styles.container}>
      ...
      <p className={styles.text}>
        Pour garantir la pertinence et l'actualisation de vos analyses, nous proposons une formule d'abonnement mensuel.<br />
